  ...
  getAddress(tipper, function(err, address) {
    if (err) {
      ...
      fields: [
        ...
        {
          name: '__Address__',
          value: '[' + address + '](https://ravencoin.network/address/' + address + ')',
          inline: true
        }
      ]
    };
      ...
      rvn.sendFrom(tipper, address, Number(amount), function(err, txId) {
        if (err) {
          ...
          fields: [
            ...
            {
              name: '__Address__',
              value: '[' + address + '](https://ravencoin.network/tx/' + address + ')',
              inline: true
            },
            {
              name: '__Fee__',
          ...
          rvn.sendFrom(tipper, address, Number(amount), 1, null, null, function(err, txId) {
              if (err) {
                ...
                if (privacyFlag) {
                  ...
                  title: '**:money_with_wings::moneybag:Ravencoin (RVN) Transaction Completed!:moneybag::money_with_wings:**',
                  description: ':confetti_ball::heart_eyes::moneybag::money_with_wings::money_mouth:<@' + msg.author.username + '> **Tipped  ' + amount + ' RVN** to <@' + recipient + '>:money_mouth: :money_with_wings::moneybag::heart_eyes::confetti_ball:',
                  color: 1363892,
                  fields: [
                    {
                      name: '__Fee__',
