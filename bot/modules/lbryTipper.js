...
function doBalance(message, tipper) {
  lbry.getBalance(tipper, 1, function(err, balance) {
    if (err) {
      message.reply('Error getting LBRY balance.').then(message => message.delete(5000));
    } else {
...
function doDeposit(message, tipper) {
  getAddress(tipper, function(err, address) {
    if (err) {
      message.reply('Error getting your LBRY deposit address.').then(message => message.delete(5000));
    } else {
...
function doWithdraw(message, tipper, words, helpmsg) {
  ...
  if (amount === null) {
    message.reply("I don't know how to withdraw that many LBRY coins...").then(message => message.delete(5000));
    return;
  }
...
function doTip(message, tipper, words, helpmsg) {
  ...
  if (amount === null) {
    message.reply("I don't know how to tip that many LBRY coins...").then(message => message.delete(5000));
    return;
  }
